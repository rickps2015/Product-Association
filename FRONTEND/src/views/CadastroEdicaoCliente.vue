<template>
    <div class="container">
        <div class="card rounded-2">
            ...
            <div class="card-body">
                <form ref="form" @submit.prevent="submissaoFormulario">
...
export default {
    ...
    methods: {
        submissaoFormulario() {
            ...
            if (this.validarCPF(this.cliente.cpf)) form.querySelector('#cpf').classList.remove('is-invalid');
            else form.querySelector('#cpf').classList.add('is-invalid');

            if (this.validarTelefone(this.cliente.telefone)) form.querySelector('#telefone').classList.remove('is-invalid');
            else form.querySelector('#telefone').classList.add('is-invalid');
        ...
        validarTelefone(telefone) {
            ...
            // Verifica se é um código de area é existente
        ...
        formatarCPF() {
            ...
            } else this.cliente.cpf = formattedCPF;
        },
        ...
        formatarTelefone() {
            ...
            if (numeroLimpo.length >= 1) formatoTelefone = '(' + numeroLimpo.substring(0, 2);
            if (numeroLimpo.length >= 3) formatoTelefone += ') ' + numeroLimpo.substring(2, 7);
            if (numeroLimpo.length >= 8) formatoTelefone += '-' + numeroLimpo.substring(7, 11);
